...
import static demo.codeanalyzer.common.util.CodeAnalyzerConstants.*;
...
public class RuleLoader {
	...
	static {
		 ...
		 */
		try {
			JAXBContext jc = JAXBContext.newInstance(Rules.class.getPackage().getName(), RuleLoader.class.getClassLoader());
			Unmarshaller unmarshaller = jc.createUnmarshaller();
			// Load rules.xml file
			InputStream inStream = RuleLoader.class.getClassLoader().getResourceAsStream(RULE_CONFIG_FILE);
