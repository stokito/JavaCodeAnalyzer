...
public class CodeAnalyzer {
	...
	public void process(String className) {
		...
		if (problems != null) {
			System.err.println("********** " + problems.size() + " Problems Found **********");
			for (ErrorDescription errorDetails : problems) {
				...
				System.err.println("Error Message: " + errorMessage + ". Line Num: " + locDetails.getLineNumber() + " offset " + locDetails.getStartOffset() + " - " + locDetails.getEndOffset());
			}
			System.err.println("******************************");
		} else {
